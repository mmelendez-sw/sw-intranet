    ...
    <div className={`home-page ${isAuthenticated ? 'authenticated' : 'unauthenticated'}`}>
      {isAuthenticated ? (
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-start', gap: '6px', width: '100%' }}>
          ...
          <div className="content-container" style={{ border: '1px solid #e0e0e0', borderRadius: '10px', background: '#fafbfc', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', margin: '40px 0 0 30px', maxWidth: '1550px', width: '100%', minWidth: '320px', padding: '0 16px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div className="main-content" style={{ flex: 1, width: '100%' }}>
              {/* Power BI Report Embed */}
              <div
                className="powerbi-embed-container"
                style={{ width: '100%', maxWidth: '1550px', height: '500px', margin: '0 0 0 0', padding: 0, background: '#fff', border: 'none', borderBottom: 'none', borderRadius: '10px', boxShadow: '0 2px 8px rgba(0,0,0,0.07)', display: 'flex', justifyContent: 'center', position: 'relative', overflow: 'hidden', alignItems: 'flex-start', top: 0 }}
              >
                <iframe
          ...
          {/* Sidebar White Box */}
          <aside className="sidebar sidebar-narrow" style={{ padding: '16px', minWidth: '320px', maxWidth: '560px', width: '100%', boxSizing: 'border-box', background: '#fff', borderLeft: '2px solid #e0e0e0', borderRight: '2px solid #e0e0e0', marginLeft: '56px', marginTop: '40px', boxShadow: '2px 0 12px 0 rgba(0,0,0,0.07)', height: 'fit-content' }}>
      ...
      <style>{`
        ...
        @media (max-width: 1100px) {
          .content-container { max-width: 100vw !important; padding: 0 4px !important; }
          .powerbi-embed-container { max-width: 100vw !important; }
          .sidebar.sidebar-narrow { max-width: 100vw !important; min-width: 220px !important; }
        }
      `}</style>
    </div>
  );
