...
const MOCK_TICKER: TickerItem[] = [
  ...
  { id: 't2', text: '📣 Submit your two leads this month in the Leads App', order: 2 },
...
const MOCK_REPORTS: ReportItemContent[] = [
  ...
  { order: 3, title: 'Daily Opportunity Count', description: 'A daily count of current opportunities.', link: '', isEliteOnly: false, excludedEmails: [], includedEmails: [] },
