 ...
 *
 * Override drive / file / folder via env (see server/.env.example).
 */

const TV_SHAREPOINT_DRIVE_ID =
  process.env.TV_SHAREPOINT_DRIVE_ID ||
  'b!PRZFjpqB2U6dHC5-1xRK-ckNeOcC0b9OuYzaxCUuqlF98qlI6Tz8RYjJa1ViXSq_';
const TV_HOMEPAGE_CARDS_ITEM_ID =
  process.env.TV_HOMEPAGE_CARDS_ITEM_ID || '01UIS5FCXU77HFE7F73JAI4TKRF5NURVFT';
const DEFAULT_IMAGES_FOLDER_PATH =
  process.env.DEFAULT_IMAGES_FOLDER_PATH || 'General/intranet/Default Images';
...
async function getGraphAccessToken() {
  const tenantId = requireEnv('POWERBI_TENANT_ID', 'TENANT_ID', 'MICROSOFT_TENANT_ID');
  const clientId = requireEnv('POWERBI_CLIENT_ID', 'CLIENT_ID', 'MICROSOFT_CLIENT_ID');
